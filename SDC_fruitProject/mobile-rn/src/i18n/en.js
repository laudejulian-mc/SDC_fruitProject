...
const en = {
  ...
  history: {
    ...
    clearAll: 'Clear all',
    searchId: 'Search ID…',
    searchPlaceholder: 'Search by fruit or label…',
    records: 'records',
  ...
  chatbot: {
    ...
    greeting: "Hello! I'm Dr. FruitMD 🩺 Your AI fruit health specialist. How can I help you today?",
    defaultReply: "I'm not sure how to respond to that. Try asking about fruits!",
    errorReply: 'Sorry, something went wrong. Please try again.',
    suggestions: 'Suggested Questions',
    inputPlaceholder: 'Ask Dr. FruitMD anything about fruits…',
    quick_what_is_fruitmd: 'What is FruitMD?',
    quick_how_to_detect: 'How do I detect fruit quality?',
    quick_supported_fruits: 'What fruits are supported?',
    quick_freshness_tips: 'Tips for keeping fruit fresh',
    quick_accuracy: 'How accurate is the AI?',
  ...
  quality: {
    ...
    lowResolution: 'Low resolution image',
    tooLarge: 'File is very large',
  ...
  lighting: {
    ...
    low: 'Low Light',
    tooDark: 'Too Dark',
    moveBrighter: 'Move to brighter area',
  },

  // ─── #16 Auto Image Enhancement ─────────────────────────
  enhance: {
    title: 'Auto-Enhance',
  ...
  compare: {
    ...
    compareBtn: 'Compare',
    vsLabel: 'VS',
    noSelection: 'Select exactly 2 records from the list above.',
  ...
  // ─── #5 Fruit Boundary Detection (UI only) ─────────────
  boundary: {
